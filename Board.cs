...
namespace _4_Way_Chess
{
    class Board
    {
        ...
        {
            //foreach (Rectangle WB in WhiteBox)
            //{
            //    spriteBatch.Draw(WhiteSprite, WB, Color.White);
            //}
        ...
        {
            WhiteSprite = contentManager.Load<Texture2D>("testsquare");
            //BoardSprite = contentManager.Load<Texture2D>("Board");
            BoardSprite = contentManager.Load<Texture2D>("b22");

            //BoardRect = new Rectangle(-18, -20, BoardSprite.Width, BoardSprite.Height + 10);
            BoardRect = new Rectangle(M + 42, T + 22, BoardSprite.Width + 3, BoardSprite.Height + 10);
        }
    }
}
